            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                ...
                <Link
                  ...
                  to="/"
                  className={`px-4 py-4 lg:py-2 text-slate-100 transition-colors duration-300 transform rounded-md lg:mt-0 [&:not(.active)]:hover:bg-slate-700 [&:not(.active)]:hover:text-slate-100  ${location.pathname.includes("/media") || location.pathname === "/" ? "bg-slate-50 text-slate-900 hover:text-slate-900 active"
                    : "bg-slate-800"
                    }`}
                >
                  xVidéos
                ...
                <Link
                  ...
                  to="/lives"
                  className={`px-4 py-4 lg:py-2 text-slate-100 transition-colors duration-300 transform rounded-md lg:mt-0 [&:not(.active)]:hover:bg-slate-700 [&:not(.active)]:hover:text-slate-100  ${location.pathname.includes("/live") ? "bg-slate-50 text-slate-900 hover:text-slate-900 active"
                    : "bg-slate-800"
                    }`}
                >
                  xLives

              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                  />
                  <a href="#" className="text-gray-700 dark:text-gray-200">Mot de passe oublié ?</a>
                </div>

                <div className="mt-6">
                <a href="/signup" className="text-gray-700 dark:text-gray-200">Vous n'avez pas de compte ?</a>
                  <button className="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Se connecter</button>
                </div>
              </form>
            </div>
          </div>
